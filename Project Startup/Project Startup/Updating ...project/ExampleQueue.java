...
public class ExampleQueue
{
        ...
        void arrangePrefenceWise(PriorityQueue<Student> p)
        {
        	  for(Student t : p)
        	  {
        	  	  ...
        	  	  else if(t.pref1=="Chemistry"&&chem<10)
        	  	  {
        	  	  	System.out.println("two");
        	  	  	chemistry[chem]=t;
        	  	  	chem++;
        	  	  }
        	  	  else if(t.pref1=="Maths"&&ma<15)
                  {
                  	System.out.println("three");
                  	maths[ma]=t;
                  	ma++;
                  }                
                  else if(t.pref1=="Biotech"&&bio<10)
                  {
                  	System.out.println("four");
                  	biotech[bio]=t;
                  	bio++;
                  }
                  else if(t.pref1=="Engneering"&&eng<15)
                  {
